...
public class DataInfoUseCase {
    ...
    public Page<DataInfoBO> findByPage(DataInfoQueryBO queryBO) {
        ...
        if (!(userUseCase.isAdmin(queryBO.getCurrentUserId()))) {
            lambdaQueryWrapper.eq(DataInfo::getAssignedTo, queryBO.getCurrentUserId());
        }
    ...
    public LambdaQueryWrapper<DataInfo> commonDataQueryWrapper(DataInfoQueryBO queryBO) {
        ...
        // lambdaQueryWrapper.eq(ObjectUtil.isNotNull(queryBO.getCurrentUserId()), DataInfo::getAssignedTo, queryBO.getCurrentUserId());
